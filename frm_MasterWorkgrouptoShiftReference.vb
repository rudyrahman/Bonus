...
Public Class frm_MasterWorkgrouptoShiftReference
    ...
    End Function
    Private Sub frm_MasterWorkgrouptoShiftReference_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btn_tambahbaru_Click(sender As Object, e As EventArgs) Handles btn_tambahbaru.Click
        frm_MasterWorkgrouptoShiftReferenceAddNew.ShowDialog()
    End Sub
    ...
    Private Sub frm_MasterWorkgrouptoShiftReference_Resize(sender As Object, e As EventArgs) Handles Me.Resize
