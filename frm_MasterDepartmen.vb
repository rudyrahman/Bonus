...
Public Class frm_MasterDepartment
    ...
    Private Sub frm_MasterDepartmen_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            strs = "SELECT * FROM  [AN_SUMATRA].[dbo].[TM_tb_department] order by [id]"
    ...
    Private Sub frm_MasterDepartmen_Resize(sender As Object, e As EventArgs) Handles Me.Resize
        If Me.Height > 300 Then
            ...
            dgv_MasterDepartment.Top = 66
            dgv_MasterDepartment.Height = Me.Height - 180
    ...
    Private Sub btn_ExportToExcel_Click(sender As Object, e As EventArgs) Handles btn_ExportToExcel.Click
        Try
            ...
            For j = 0 To dgv_MasterDepartment.Columns.Count - 1

                excelworksheet.Cells(1, j + 1) = dgv_MasterDepartment.Columns(j).HeaderText
                For i = 1 To dgv_MasterDepartment.Rows.Count - 1
                    '
                    excelworksheet.Cells(i + 1, j + 1) = "'" & dgv_MasterDepartment(j, i - 1).Value.ToString
                Next
