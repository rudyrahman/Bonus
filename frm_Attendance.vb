...
Public Class frm_Attendance
    ...
    Private Sub frm_Attendance_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'ukuran form
    ...
    Private Sub frm_Attendance_Resize(sender As Object, e As EventArgs) Handles Me.Resize
        If Me.WindowState < FormWindowState.Minimized Then
            ...
            dgv_data.Top = 125
            dgv_data.Height = Me.Height - 250
            dgv_data.Width = Me.Width - 100
            'akhir kode
