...
Public Class frm_MasterWorkgroupRelation
    ...
    End Function
    Private Sub frm_MasterWorkgroupRelation_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btn_tambahbaru_Click(sender As Object, e As EventArgs) Handles btn_tambahbaru.Click
        frm_MasterWorkgroupRelationAddNew.ShowDialog()
    End Sub
